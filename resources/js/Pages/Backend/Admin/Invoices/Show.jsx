...
export default function InvoiceShow() {
    ...
    const handlePdf = () => {
        ...
        window.open(route('admin.invoices.pdf', invoice.id) + query, '_blank');
    };
    ...
    return (
        <DashboardLayout title={`Fatura #${invoice.number}`}>
            <div className="max-w-7xl mx-auto px-4 py-10 space-y-6">
                ...
                <Link href={route('admin.invoices.index')} className="text-gray-600 dark:text-gray-300 hover:underline flex items-center gap-2">
                    <FaArrowLeft /> Voltar
                </Link>
                ...
                <div className="flex items-end justify-between mb-4 gap-4">
                    ...
                    <div className="w-64">
                        ...
                        >
                            ...
                            <option value="secretary">Administrador</option>
                        </select>
                    </div>
