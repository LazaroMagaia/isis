...
export default function InvoicesIndex() {
    ...
    const handleFilter = (e) => {
        e.preventDefault();
        router.get(route("secretary.invoices.index"), {
            search,
            status,
    ...
    const handleCancel = (invoiceId, invoiceNumber) => {
        Swal.fire({
            ...
            if (result.isConfirmed) {
                router.delete(route("secretary.invoices.destroy", invoiceId), {
                    onSuccess: () => {
        ...
        },
        {
            ...
            render: (row) => (
                <div className="flex justify-end items-center gap-2">
                    <Link
                        href={route("secretary.invoices.show", row.id)}
            ...
            <div className="max-w-7xl mx-auto px-4 py-10">
                ...
                <div className="bg-white dark:bg-gray-800 rounded-xl shadow p-6">
                    <div className="flex justify-between items-center mb-4">
                        ...
                        <Link
                            href={route("secretary.invoices.create")}
