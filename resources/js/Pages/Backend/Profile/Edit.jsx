...
export default function EditUser() {
        ...
        if (user) {
            setValues({
                ...
                ? Array.isArray(user.specialties)
                    ...
                    : user.specialties.replace(/[\[\]"]+/g, '') // caso venha como string JSON
                : '',
            });
        }
    }, [user]);
    ...
    const handleSubmit = (e) => {
        ...
        router.put(route('secretary.profile.update', user.id), values, {
            onSuccess: () => Swal.fire({ icon: 'success', title: 'Perfil atualizado!', confirmButtonColor: '#8B57A4' }),
            onError: () => Swal.fire({ icon: 'error', title: 'Erro ao atualizar perfil', confirmButtonColor: '#8B57A4' }),
        });
    };
